...
export function PlatformAnalyticsPage() {
  ...
  const { dailyActiveUsers, coursePopularity, trafficData } = mockPlatformAnalytics;
  ...
  const engagementByHour = [
    { hour: '00:00', users: 150 },
    { hour: '04:00', users: 80 },
    { hour: '08:00', users: 450 },
    { hour: '12:00', users: 680 },
    { hour: '16:00', users: 720 },
    { hour: '20:00', users: 890 },
  ];

  const topCountries = [
    { country: 'United States', users: 3200, percentage: 38 },
    { country: 'India', users: 1800, percentage: 21 },
    { country: 'United Kingdom', users: 950, percentage: 11 },
    { country: 'Canada', users: 680, percentage: 8 },
    { country: 'Germany', users: 520, percentage: 6 },
  ];
